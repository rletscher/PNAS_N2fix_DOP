...
# Model 3: Iron limitation is function of dissolved [Fe] & diazotroph DIP uptake is function of P*
...
function diaz_DIP(x, p)
    ...
    t_val = t(p)
     ...
     @. αd * (p2c_v * NPP_v / NPP0 / (WOAPO4_v / DIP0))^β * Pstar_v * Fe_v_norm * t_val * (z_top ≤ 73)
end
...
jldsave("output_Model3_20.jld2"; DIP=DIP, DOP=DOP, POP=POP, Jfix=Jfix, tp_opt=tp_opt, hess=hess)

matwrite("pooloutput_Model3_20.mat", Dict(
